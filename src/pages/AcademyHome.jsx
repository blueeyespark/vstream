...
const cards=[
  ...
  {title:"Creator Campus",detail:"Learn content creation, practice in CreatorOS, and choose what videos or streams you publish to VStream.",icon:Hammer,to:"/Academy/CreatorCampus"},
];
