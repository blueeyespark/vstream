...
export default function CalendarPage() {
  ...
  const { refetch: refetchTasks } = useQuery({
    queryKey: ['tasks'],
    queryFn: () => platform.entities.Task.list('-due_date'),
  });
  const { refetch: refetchMeetings } = useQuery({
    queryKey: ['meetings'],
    queryFn: () => platform.entities.Meeting.list('-date'),
  });
  ...
  const { data: blogPosts = [] } = useQuery({
    queryKey: ['blogPosts'],
    queryFn: () => platform.entities.BlogPost.list('-created_date'),
  });

  const { data: socialPosts = [] } = useQuery({
    queryKey: ['socialPosts'],
    queryFn: () => platform.entities.SocialPost.list('-posted_date'),
  });
